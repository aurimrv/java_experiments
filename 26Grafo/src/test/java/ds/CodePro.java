...
public class CodePro {
	...
	public void testExisteAresta_1()
		...
		fixture.prox = new int[] {};
		fixture.peso = new int[] {};
		fixture.cab = new int[] {};
		int v1 = 1;
		int v2 = 1;
		...
		//       at ds.Grafo.existeAresta(Grafo.java:50)
		assertTrue(result);
	}
	 ...
	 */
	@Test(expected=java.lang.ArrayIndexOutOfBoundsException.class)
	public void testExisteAresta_3()
		throws Exception {
		Grafo fixture = new Grafo(1);
		fixture.prox = new int[] {};
		fixture.peso = new int[] {};
	...
	public void testGrafoTransposto_1()
		...
		//       at ds.Grafo.listaAdjVazia(Grafo.java:56)
		//       at ds.Grafo.grafoTransposto(Grafo.java:95)
		assertNotNull(result);
	}
	...
	public void testImprime_2()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ArrayIndexOutOfBoundsException: 0
		//       at ds.Grafo.imprime(Grafo.java:87)
	}
	...
	public void testInsereAresta_1()
		throws Exception {
		Grafo fixture = new Grafo(1);
		fixture.prox = new int[] {0};
		fixture.peso = new int[] {};
		fixture.cab = new int[] {0};
		int v1 = 1;
		int v2 = 1;
		int peso = 1;
	 ...
	 */
	@Test(expected=java.lang.ArrayIndexOutOfBoundsException.class)
	public void testInsereAresta_2()
		throws Exception {
		Grafo fixture = new Grafo(1);
		fixture.prox = new int[] {};
		fixture.peso = new int[] {};
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ArrayIndexOutOfBoundsException: 1
		//       at ds.Grafo.insereAresta(Grafo.java:44)
	}
	...
	public void testPrimeiroListaAdj_1()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ArrayIndexOutOfBoundsException: 1
		//       at ds.Grafo.primeiroListaAdj(Grafo.java:61)
		assertNotNull(result);
	}
	...
	public void testProxAdj_1()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ArrayIndexOutOfBoundsException: 1
		//       at ds.Grafo.proxAdj(Grafo.java:67)
		assertNotNull(result);
	}
	...
	public void testRetiraAresta_1()
		...
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ArrayIndexOutOfBoundsException: 1
		//       at ds.Grafo.retiraAresta(Grafo.java:73)
		assertNotNull(result);
	}
