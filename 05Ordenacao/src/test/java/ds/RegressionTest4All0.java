...
public class RegressionTest4All0 {
  ...
  public void test1() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest4All0.test1"); }
  ...
  public void test2() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest4All0.test2"); }
  ...
  public void test3() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest4All0.test3"); }
  ...
  public void test4() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest4All0.test4"); }
  ...
  public void test5() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest4All0.test5"); }
  ...
  public void test6() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest4All0.test6"); }
  ...
  public void test7() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest4All0.test7"); }
  ...
  public void test8() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest4All0.test8"); }
