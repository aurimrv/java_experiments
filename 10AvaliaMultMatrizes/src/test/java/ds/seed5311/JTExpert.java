...
Coverage : 100%
Evaluations : 62378
search time (ms): 22022
total runtime (ms): 23571
 */
public class JTExpert {
  /** 
 * Chromosome :
1)----->ds.AvaliaMultMatrizes[]
2)----->multmatrize[1, [189,-567,208]]
 ...
 */
  @Test public void TestCase0() throws Throwable {
    ...
    int[] clsUTAvaliaMultMatrizesP2P2=new int[]{189,-567,208};
      AvaliaMultMatrizes.multmatrize(clsUTAvaliaMultMatrizesP2P1,clsUTAvaliaMultMatrizesP2P2);
    assertTrue(Arrays.equals(new int[]{189,-567,208},clsUTAvaliaMultMatrizesP2P2));
  }
  /** 
 * Chromosome :
1)----->ds.AvaliaMultMatrizes[]
2)----->multmatrize[2, [282,547,1]]
 ...
 */
  @Test public void TestCase1() throws Throwable {
    ...
    int[] clsUTAvaliaMultMatrizesP2P2=new int[]{282,547,1};
      AvaliaMultMatrizes.multmatrize(clsUTAvaliaMultMatrizesP2P1,clsUTAvaliaMultMatrizesP2P2);
    assertTrue(Arrays.equals(new int[]{282,547,1},clsUTAvaliaMultMatrizesP2P2));
  }
  /** 
 * Chromosome :
1)----->ds.AvaliaMultMatrizes[]
2)----->multmatrize[3, [-614,304,981,-863]]
 Covered Branches:[1, 2, 3, 4, 5, 6, 7]
 */
  @Test public void TestCase2() throws Throwable {
    ...
    int[] clsUTAvaliaMultMatrizesP2P2=new int[]{-614,304,981,-863};
      AvaliaMultMatrizes.multmatrize(clsUTAvaliaMultMatrizesP2P1,clsUTAvaliaMultMatrizesP2P2);
    assertTrue(Arrays.equals(new int[]{-614,304,981,-863},clsUTAvaliaMultMatrizesP2P2));
  }
}
