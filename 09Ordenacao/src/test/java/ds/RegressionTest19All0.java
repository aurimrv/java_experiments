...
public class RegressionTest19All0 {
  ...
  public void test2() throws Throwable {
    ...
    try {
    ds.Ordenacao.mergeSort(i_array0, (int)(byte)10, (int)'#');
  ...
  public void test3() throws Throwable {
    ...
    int[] i_array4 = new int[] { '#', (byte)(-1), (byte)1, (short)100 };
    ds.Ordenacao.mergeSort(i_array4, (int)' ', 0);
    ds.Ordenacao.mergeSort(i_array4, (int)'#', (int)(byte)0);
    ds.Ordenacao.mergeSort(i_array4, (int)(short)0, 0);
    // The following exception was thrown during execution in test generation
    try {
    ds.Ordenacao.mergeSort(i_array4, (int)(short)0, (int)(byte)10);
      org.junit.Assert.fail("Expected exception of type java.lang.ArrayIndexOutOfBoundsException");
    } catch (java.lang.ArrayIndexOutOfBoundsException e) {
      // Expected exception.
      if (! e.getClass().getCanonicalName().equals("java.lang.ArrayIndexOutOfBoundsException")) {
  ...
  public void test4() throws Throwable {
    ...
    // The following exception was thrown during execution in test generation
    try {
    ds.Ordenacao.mergeSort(i_array4, 10, 100);
      org.junit.Assert.fail("Expected exception of type java.lang.ArrayIndexOutOfBoundsException");
    } catch (java.lang.ArrayIndexOutOfBoundsException e) {
      // Expected exception.
      if (! e.getClass().getCanonicalName().equals("java.lang.ArrayIndexOutOfBoundsException")) {
  ...
  public void test5() throws Throwable {
    ...
    ds.Ordenacao.mergeSort(i_array1, (int)(byte)100, (int)(short)(-1));
    ds.Ordenacao.mergeSort(i_array1, 100, (-1));
  ...
  public void test6() throws Throwable {
    ...
    int[] i_array1 = new int[] { (short)0 };
    ds.Ordenacao.mergeSort(i_array1, 0, 0);
    ds.Ordenacao.mergeSort(i_array1, (int)(short)1, 0);
