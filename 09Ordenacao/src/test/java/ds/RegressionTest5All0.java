...
public class RegressionTest5All0 {
  ...
  public void test3() throws Throwable {
    ...
    int[] i_array6 = new int[] { (byte)100, 'a', 100, (short)(-1), (short)10, (-1) };
    ds.Ordenacao.mergeSort(i_array6, (int)'4', 0);
    // The following exception was thrown during execution in test generation
    try {
    ds.Ordenacao.mergeSort(i_array6, (int)(short)10, (int)'4');
  ...
  public void test5() throws Throwable {
    ...
    // The following exception was thrown during execution in test generation
    try {
    ds.Ordenacao.mergeSort(i_array4, 0, (int)(byte)10);
      org.junit.Assert.fail("Expected exception of type java.lang.ArrayIndexOutOfBoundsException");
    } catch (java.lang.ArrayIndexOutOfBoundsException e) {
      // Expected exception.
      if (! e.getClass().getCanonicalName().equals("java.lang.ArrayIndexOutOfBoundsException")) {
  ...
  public void test6() throws Throwable {
    ...
    ds.Ordenacao.mergeSort(i_array0, (int)'4', (int)(byte)10);
  ...
  public void test7() throws Throwable {
    ...
    int[] i_array6 = new int[] { (byte)100, 'a', 100, (short)(-1), (short)10, (-1) };
    ds.Ordenacao.mergeSort(i_array6, (int)'4', 0);
    ds.Ordenacao.mergeSort(i_array6, (int)(short)0, (int)(byte)0);
    ds.Ordenacao.mergeSort(i_array6, (int)'4', (int)(short)1);
  ...
  public void test8() throws Throwable {
    ...
    int[] i_array4 = new int[] { (byte)10, 1, (byte)(-1), (byte)(-1) };
  ...
  public void test9() throws Throwable {
    ...
    if (debug) { System.out.format("%n%s%n","RegressionTest5All0.test9"); }
