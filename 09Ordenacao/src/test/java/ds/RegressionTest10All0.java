...
public class RegressionTest10All0 {
  ...
  public void test03() throws Throwable {
    ...
    ds.Ordenacao.mergeSort(i_array1, 10, (int)(byte)10);
    // The following exception was thrown during execution in test generation
    try {
  ...
  public void test04() throws Throwable {
    ...
    int[] i_array1 = new int[] { 0 };
    ds.Ordenacao.mergeSort(i_array1, 10, (int)(byte)10);
    ds.Ordenacao.mergeSort(i_array1, (int)(byte)10, 10);
  ...
  public void test09() throws Throwable {
    ...
    // The following exception was thrown during execution in test generation
    try {
    ds.Ordenacao.mergeSort(i_array1, (int)(short)10, (int)'a');
      org.junit.Assert.fail("Expected exception of type java.lang.ArrayIndexOutOfBoundsException");
    } catch (java.lang.ArrayIndexOutOfBoundsException e) {
      // Expected exception.
      if (! e.getClass().getCanonicalName().equals("java.lang.ArrayIndexOutOfBoundsException")) {
  ...
  public void test11() throws Throwable {
    ...
    int[] i_array1 = new int[] { 0 };
    ds.Ordenacao.mergeSort(i_array1, 10, (int)(byte)10);
    ds.Ordenacao.mergeSort(i_array1, (int)'#', (int)(short)10);
  ...
  public void test12() throws Throwable {
    ...
    int[] i_array3 = new int[] { (byte)100, (byte)10, (byte)0 };
    ds.Ordenacao.mergeSort(i_array3, 0, (-1));
  ...
  public void test13() throws Throwable {
    ...
    int[] i_array1 = new int[] { 0 };
    ds.Ordenacao.mergeSort(i_array1, 10, (int)(byte)10);
    ds.Ordenacao.mergeSort(i_array1, (int)(byte)0, (int)(short)(-1));
    ds.Ordenacao.mergeSort(i_array1, (int)(short)100, (int)'#');
    ds.Ordenacao.mergeSort(i_array1, (int)(byte)1, (int)(byte)1);
